...
import library.service.tracing.TraceIdMessagePostProcessor
...
internal class MessagingBookEventDispatcherTest {
    ...
    private val postProcessor: TraceIdMessagePostProcessor = mockk()
    private val eventCounter: DomainEventSendCounter = mockk()
    ...
    private val allBookEventTypes = listOf(
